...
<body>
	...
	<div class="container col-md-4">
		...
		<form class="px-2" action="/submit" method="POST">
			...
			<div class="form-group">
				<label>Limite</label> <input type="number" class="form-control"
					name="limit" value="${limit}" placeholder=10 value=0 min=0 max=999999>
			...
			<div class="form-group">
				<label>Código postal</label> <input type="text"
					placeholder="ABCD1234" class="form-control" name="code"
					value="${code}">
		...
		<form action="/clean" class="btn-group" method="POST">
